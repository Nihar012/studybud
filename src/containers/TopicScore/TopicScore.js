...
import classes from './Topicscore.css';
import CSSTransition from 'react-transition-group/CSSTransition';
import UploadSyllabus from '../../components/tesseract/UploadSyllabus/UploadSyllabus';

class TopicScore extends Component {
    ...
    render() {
        ...
        if(this.props.uploadingSyllabus){
            itemOptions = <UploadSyllabus />;
        }
...
const mapStateToProps = state => {
    return {
        ...
        uploadingSyllabus: state.inputFormUI.uploadingSyllabus,
...
export default connect(mapStateToProps, mapDispatchToProps)(TopicScore);